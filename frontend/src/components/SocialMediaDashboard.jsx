...
const SocialMediaDashboard = () => {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
          ...
          <div className="px-3 sm:px-4 md:px-6 py-3 md:py-4">
            <div className="flex items-center justify-between gap-2 sm:gap-3 md:gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`text-gray-400 ${isDarkMode ? 'text-gray-500' : ''}`}>|</span>
                <div className={`text-sm lg:text-base ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>
          ...
          <div className="relative h-full">
            ...
            <div className="text-center py-12">
              <div className={`w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 ${
                ...
                <AlertCircle className={`w-12 h-12 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`} />
              </div>
              <h3 className={`text-xl font-semibold mb-2 ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>No Social Media Posts</h3>
              <p className={`mb-6 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Connect your social media accounts to see your latest posts</p>
              <button
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
                ...
                {platformsWithPosts.map((platform) => {
                  ...
                  return (
                    <div key={platform} className={`rounded-lg shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden ${
                      isDarkMode
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                {accountUsername !== accountName && (
                                  <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>@{accountUsername}</p>
                                )}
                              </div>
                            </div>
                          ...
                          <div className="px-4 py-2">
                            ...
                            <div className="mb-2">
                              <p className={`text-sm ${isDarkMode ? 'text-gray-200' : 'text-gray-900'}`}>
                                ...
                                <span className={`${isDarkMode ? 'text-gray-300' : 'text-gray-800'} ${!expandedCaptions.has(`${platform}-${latestPost.id}`) ? 'line-clamp-2' : ''}`}>
      ...
      {showInsightsModal && (
        <div
                className={`hidden md:flex fixed inset-y-0 right-0 w-96 border-l shadow-2xl flex-col flex-shrink-0 animate-slide-in-right overflow-hidden z-10 ${
                  isDarkMode
          ...
          >
            {/* Header */}
                ...
                <div className="min-w-0">
                      <h3 className={`text-lg font-extrabold truncate ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>Insights by Orion</h3>
              ...
              >
                ...
                <div className={`flex-1 overflow-y-auto pt-4 pl-2 pr-0 custom-scrollbar ${
                  isDarkMode ? 'bg-gray-900 dark-mode' : 'bg-gray-50 light-mode'
              ...
              {loadingInsights ? (
                <div className="flex items-center justify-center py-12">
                  <div className="text-center">
                    ...
                    }`}>Analyzing post and generating insights...</p>
                  </div>
                </div>
              ) : insightsData ? (
                ...
                {insightsData.error ? (
                  <div className="flex flex-col items-start w-full px-4">
                    <div className="flex items-start gap-2 w-full justify-start">
                      ...
                      <div className={`px-4 py-3 rounded-lg chatbot-bubble-shadow ${
                        isDarkMode ? 'bg-gray-700 text-gray-200' : 'bg-white text-black'
                      }`}>
                        <div className={`${
                          isDarkMode ? 'text-red-400' : 'text-red-800'
                        }`}>{insightsData.insights}</div>
                      </div>
                    </div>
                  </div>
                ) : (() => {
                        ...
                        <div className="flex items-start gap-2 w-full justify-start">
                          ...
                          <div className={`px-4 py-3 rounded-lg chatbot-bubble-shadow ${
                            ...
                            <ReactMarkdown
                              remarkPlugins={[remarkGfm]}
                              components={{
                                p: ({ children }) => <p className={`mb-2 last:mb-0 text-sm ${
                                  isDarkMode ? 'text-gray-200' : 'text-black'
                                }`}>{children}</p>,
                                h1: ({ children }) => <h1 className={`text-lg font-bold mb-2 ${
                                  isDarkMode ? 'text-gray-100' : 'text-black'
                                }`}>{children}</h1>,
                                h2: ({ children }) => <h2 className={`text-base font-bold mb-2 ${
                                  isDarkMode ? 'text-gray-100' : 'text-black'
                                }`}>{children}</h2>,
                                h3: ({ children }) => <h3 className={`text-sm font-bold mb-2 ${
                                  isDarkMode ? 'text-gray-100' : 'text-black'
                                }`}>{children}</h3>,
                                ul: ({ children }) => <ul className={`list-disc list-inside mb-2 text-sm ${
                                  isDarkMode ? 'text-gray-200' : 'text-black'
                                }`}>{children}</ul>,
                                ol: ({ children }) => <ol className={`list-decimal list-inside mb-2 text-sm ${
                                  isDarkMode ? 'text-gray-200' : 'text-black'
                                }`}>{children}</ol>,
                                li: ({ children }) => <li className={`text-sm ${
                                  isDarkMode ? 'text-gray-200' : 'text-black'
                                }`}>{children}</li>,
                                strong: ({ children }) => <strong className={`font-bold text-sm ${
                                  isDarkMode ? 'text-gray-100' : 'text-black'
                                }`}>{children}</strong>,
                                em: ({ children }) => <em className={`italic text-sm ${
                      ...
                      {messages.map((message, index) => (
                        <div key={index} className="flex flex-col items-start w-full px-4">
                          <div className="flex items-start gap-2 w-full justify-start">
                            ...
                            <div className={`px-4 py-3 rounded-lg chatbot-bubble-shadow text-sm ${
                              isDarkMode ? 'bg-gray-700 text-gray-200' : 'bg-white text-black'
                            }`}>
                              {message.type === 'sentiment' && message.sentimentScore !== undefined && (
                                <div className="mb-4">
                                  <div className={`relative w-full h-6 rounded-full overflow-hidden mb-2 ${
                                  ...
                                  <div className="flex items-center justify-between text-sm">
                                    ...
                                    <span className={`font-semibold ${
                                      isDarkMode ? 'text-gray-400' : 'text-gray-600'
                                    }`}>{message.percentage}% Positive</span>
