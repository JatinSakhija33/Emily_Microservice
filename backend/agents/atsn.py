...
class CreateCalendarPayload(BaseModel):
    channel: Optional[Literal["instagram", "facebook", "youtube", "linkedin"]] = None
    post_frequency: Optional[Literal["daily", "three_times_week", "two_times_week", "weekly", "bi_weekly"]] = None
    confirm_generation: Optional[Literal["yes", "no"]] = None
...
class AgentState(BaseModel):
    ...
    calendar_id: Optional[str] = None  # Calendar ID after creation
    calendar_entries: Optional[List[Dict[str, Any]]] = None  # Generated calendar entries
    calendar_month: Optional[int] = None  # Month of the calendar
    calendar_year: Optional[int] = None  # Year of the calendar
...
"intent_changed: create_calendar"
...
# Import create_content functions from separate module
...
from .view_content import (
    construct_view_content_payload,
    complete_view_content_payload,
    handle_view_content
)

# Import edit_content functions from separate module
from .edit_content import (
    construct_edit_content_payload,
    complete_edit_content_payload,
    handle_edit_content
)

# Import schedule_content functions from separate module
from .schedule_content import (
    construct_schedule_content_payload,
    complete_schedule_content_payload,
    handle_schedule_content
)

# Import delete_content functions from separate module
from .delete_content import (
    construct_delete_content_payload,
    complete_delete_content_payload,
    handle_delete_content
)

# Import create_calendar functions from separate module
from .create_calendar import (
    construct_create_calendar_payload,
    complete_create_calendar_payload,
...
# complete_create_content_payload function moved to create_content.py
