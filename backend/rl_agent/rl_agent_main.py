...
def run_one_post(BUSINESS_ID, platform, time=None, provided_topic=None):
    ...
    if provided_topic:
        topic_text = provided_topic
        print(f"🧵 Using provided topic: {topic_text}")
    else:
        #generate topic
        ...
        print(f"🧵 Generated topic: {topic_text}")
